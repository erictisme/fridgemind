    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 text-center">
          <div>
            <h1 className="text-4xl font-bold text-emerald-600">FridgeMind</h1>
            <div className="mt-8 rounded-md bg-emerald-50 p-6">
            ...
            <Link
              href="/login"
              className="mt-6 inline-block text-emerald-600 hover:text-emerald-500"
            >
              Back to login
            </Link>
          </div>
